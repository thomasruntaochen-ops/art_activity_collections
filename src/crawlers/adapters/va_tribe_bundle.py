...
VA_TRIBE_VENUES: tuple[VaTribeVenueConfig, ...] = (
    ...
    # rebuilt on Drupal. It needed a new adapter rather than a repointed Tribe URL,
    # so as of 2026-09-02 it runs standalone -- see
    # src/crawlers/adapters/branch_museum.py. Do not re-add it here.
    VaTribeVenueConfig(
        slug="virginia_moca",
