    ...
    summary = await run_targets(
        targets=[
            TargetRunSpec(
                ...
                parse_payload=lambda payload: parse_fresno_workshops_html(html=payload, list_url=args.url),
                parser_name="fresno",
